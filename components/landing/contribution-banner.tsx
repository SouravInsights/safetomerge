    ...
    <section id="contribute" className="section-band max-w-full py-16 sm:py-20 border-y border-rule">
      <Container size="narrow">
        <div className="mb-6 reveal">
          <span className="inline-block -rotate-[1.5deg] font-mono text-xs tracking-widest uppercase text-verified bg-verified/10 px-2.5 py-1 border border-verified/40 shadow-[2px_2px_0_0_color-mix(in_srgb,var(--color-verified)_30%,transparent)] transition-transform duration-200 hover:rotate-0">
        ...
        <div className="reveal reveal-d3">
          <a
            href="/contribute"
            className="group inline-flex items-center gap-2 font-mono text-xs uppercase tracking-widest border-2 border-ink bg-paper text-ink px-6 py-3.5 shadow-[3px_3px_0_0_var(--color-ink)] hover:border-verified hover:text-verified hover:shadow-none hover:translate-x-[2px] hover:translate-y-[2px] active:border-verified active:text-verified active:shadow-none active:translate-x-[2px] active:translate-y-[2px] transition-all duration-150"
          >
